		...
		recognition.onresult = function(event) {
			...
			if(final_transcript.trim() !== ""){
				(function(selection,text){
					...
					var range;
					if(selection){
							range=selection.getRangeAt(0);//sel -> selection
...
var setMenuColors = function(){
	...
	$("#menuColors").append('<div class="button left colorbutton" id="BuyBgColors" style="" title="Get more colors!"><div class="dot" style="width:13px;height:13px;margin:6px;background-color:#000000; animation:multicolor 5s infinite linear"></div></div>');
